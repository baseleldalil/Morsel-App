...
namespace WhatsApp.Shared.Migrations
{
    ...
    [Migration("20251126171826_AddWorkflowMessageAndAttachmentFields")]
    partial class AddWorkflowMessageAndAttachmentFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhatsApp.Shared.Models.CampaignWorkflow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("FemaleMessage")
                        .HasColumnType("text");

                    b.Property<string>("MaleMessage")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WhatsApp.Shared.Models.SentPhone", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WhatsApp.Shared.Models.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Key = "SAAS_NAME",
                            UpdatedAt = new DateTime(2025, 11, 26, 17, 18, 25, 772, DateTimeKind.Utc).AddTicks(9893),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2025, 11, 26, 17, 18, 25, 773, DateTimeKind.Utc).AddTicks(197),
                        ...
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2025, 11, 26, 17, 18, 25, 773, DateTimeKind.Utc).AddTicks(199),
                            Value = "0.05"
                        },
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2025, 11, 26, 17, 18, 25, 773, DateTimeKind.Utc).AddTicks(201),
                            Value = "UTC"
                        },
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2025, 11, 26, 17, 18, 25, 773, DateTimeKind.Utc).AddTicks(203),
                            Value = "10485760"
                        });
                });
            ...
            modelBuilder.Entity("WhatsApp.Shared.Models.CampaignWorkflow", b =>
                {
                    b.HasOne("WhatsApp.Shared.Models.Campaign", "Campaign")
                        .WithMany("CampaignWorkflows")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WhatsApp.Shared.Models.Contact", "Contact")
                        .WithMany()
            ...
            modelBuilder.Entity("WhatsApp.Shared.Models.Campaign", b =>
                {
                    b.Navigation("CampaignWorkflows");
